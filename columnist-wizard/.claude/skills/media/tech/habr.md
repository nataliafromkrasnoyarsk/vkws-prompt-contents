...
## Официальные правила Хабра

**Источник:** [habr.com/docs/help/rules](https://habr.com/ru/docs/help/rules/)

### КАТЕГОРИЧЕСКИ ЗАПРЕЩЕНО
```
❌ Реклама в обход правил (логотипы, фирменные цвета вне корпблогов)
❌ Видео без подробного описания и таймкодов/расшифровки
❌ Плагиат (копирование чужих текстов)
❌ Односложные статьи типа «смотрите ссылку»
❌ Жалобы на операторов/провайдеров
❌ Политические дискуссии
❌ Мат, оскорбления, троллинг
❌ Просьбы о голосах, консультациях
❌ Множественные аккаунты (виртуалы)
...
✓ Соблюдение орфографии русского языка
✓ Изображения с текстовым объяснением
✓ Крупные изображения под спойлер
```

### Для корпоративных блогов
- Упоминания компании разрешены **только в корпблоге**
- Единственная форма вне блога: подпись должности с ФИО
- Нарушения → удаление контента и блокировка аккаунта
...
Смотри коллекцию лучших статей Хабра 2024-2025 в файле:
- `examples/habr-examples.md` — топ-15 статей по просмотрам, успешные корпоративные блоги, форматы и антипаттерны
